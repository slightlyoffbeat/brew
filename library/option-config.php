...
function setup_framework_options(){
  ...
  $args['dev_mode'] = false;
	...
	$args['display_name'] = __('<h1>BREW Options</h1>', 'redux-framework');
	$args['display_version'] = ('version').' '.$theme->get('Version');
    ...
    $args['intro_text'] = __('<p>All custom options for BREW can be found here.</p>', 'redux-framework');

    // Add content after the form.
    $args['footer_text'] = __('<p>Open the pod bay doors, please.</p>', 'redux-framework');
    ...
    $args['share_icons']['twitter'] = array(
        'link' => 'http://twitter.com/slightlyoffbeat',
        'title' => 'Follow me on Twitter', 
        'img' => REDUX_URL . 'assets/img/social/Twitter.png'
    );
    $args['share_icons']['linked_in'] = array(
        'link' => 'http://www.github.com/slightlyoffbeat',
